...
export const whoweserve = [
  {
    ...
    icon: (
      <div className="size-20 grid place-items-center bg-primary/20 rounded-full">
        <Icon icon="solar:code-linear" width="24" height="24" className="text-primary size-10" />
      </div>
    ),
    title: "Developers",
    features: [
  ...
  },
  {
    ...
    icon: (
      <div className="size-20 grid place-items-center bg-primary/20 rounded-full">
        <Icon icon="solar:users-group-two-rounded-linear" width="24" height="24" className="text-primary size-10" />
      </div>
    ),
    title: "Teams",
    features: [
  ...
  },
  {
    ...
    icon: (
      <div className="size-20 grid place-items-center bg-primary/20 rounded-full">
        <Icon icon="solar:shop-2-linear" width="24" height="24" className="text-primary size-10" />
      </div>
    ),
