...
export default function WhoWeServe() {
  return (
    <section className="py-16 md:py-20 xl:py-32">
      <h2 className="text-3xl md:text-4xl font-semibold text-center tracking-tight">Who We Serve</h2>
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mt-12 md:mt-16">
        {whoweserve.map((item) => (
          <div key={item.id} className="flex flex-col items-center py-12 px-6 bg-secondary/20 border rounded-lg">
