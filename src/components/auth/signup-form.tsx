...
export function SignUpForm({ className, ...props }: React.ComponentProps<"div">) {
  ...
  async function onSubmit(data: TSignUp) {
    try {
      ...
      // Remove the navigate call - the RedirectIfAuth will handle the redirect
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-4">
            <div className="grid gap-3">
              ...
              <Input id="name" type="text" placeholder="John Doe" className="h-10" {...register("name")} />
            ...
            <Button size="lg" type="submit" className="w-full" disabled={isSubmitting || isLoading}>
              Sign Up
              {isSubmitting && (
